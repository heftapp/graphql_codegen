...
class Query$Q {
  Query$Q({this.q, this.$__typename = 'Query'});

  factory Query$Q.fromJson(Map<String, dynamic> json) {
    final l$q = json['q'];
    final l$$__typename = json['__typename'];
    return Query$Q(q: (l$q as String?), $__typename: (l$$__typename as String));
  }
  ...
  int get hashCode {
    final l$q = q;
    final l$$__typename = $__typename;
    return Object.hashAll([l$q, l$$__typename]);
  }
...
abstract class CopyWith$Query$Q<TRes> {
  ...
  TRes call({String? q, String? $__typename});
}
...
class _CopyWithImpl$Query$Q<TRes> implements CopyWith$Query$Q<TRes> {
  ...
  TRes call({Object? q = _undefined, Object? $__typename = _undefined}) =>
      _then(
        Query$Q(
...
class _CopyWithStubImpl$Query$Q<TRes> implements CopyWith$Query$Q<TRes> {
  ...
  call({String? q, String? $__typename}) => _res;
}
