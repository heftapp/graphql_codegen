...
class Query$Foobar {
  Query$Foobar({this.ts, this.tss, this.$__typename = 'Query'});
...
abstract class CopyWith$Query$Foobar<TRes> {
  ...
  TRes tss(
    Iterable<Iterable<Query$Foobar$tss?>?>? Function(
      Iterable<Iterable<CopyWith$Query$Foobar$tss<Query$Foobar$tss>?>?>?,
    )
    _fn,
  );
}
...
class _CopyWithImpl$Query$Foobar<TRes> implements CopyWith$Query$Foobar<TRes> {
  ...
  TRes ts(
    ...
    ts: _fn(
      _instance.ts?.map(
        (e) => e == null ? null : CopyWith$Query$Foobar$ts(e, (i) => i),
      ),
    )?.toList(),
  );
  ...
  TRes tss(
    ...
    tss: _fn(
      _instance.tss?.map(
        (e) => e?.map(
          (e) => e == null ? null : CopyWith$Query$Foobar$tss(e, (i) => i),
        ),
      ),
...
const documentNodeQueryFoobar = DocumentNode(
  definitions: [
...
class Query$Foobar$ts {
  Query$Foobar$ts({this.t, this.name, this.$__typename = 'TS'});
  ...
  int get hashCode {
    ...
    final l$name = name;
    final l$$__typename = $__typename;
    return Object.hashAll([l$t, l$name, l$$__typename]);
  }
...
extension UtilityExtension$Query$Foobar$ts on Query$Foobar$ts {
  CopyWith$Query$Foobar$ts<Query$Foobar$ts> get copyWith =>
      CopyWith$Query$Foobar$ts(this, (i) => i);
}
...
class _CopyWithStubImpl$Query$Foobar$ts<TRes>
  ...
  call({Query$Foobar$ts$t? t, String? name, String? $__typename}) => _res;
...
class Query$Foobar$ts$t {
  Query$Foobar$ts$t({this.name, this.$__typename = 'TS'});
...
extension UtilityExtension$Query$Foobar$ts$t on Query$Foobar$ts$t {
  CopyWith$Query$Foobar$ts$t<Query$Foobar$ts$t> get copyWith =>
      CopyWith$Query$Foobar$ts$t(this, (i) => i);
}
...
class _CopyWithImpl$Query$Foobar$ts$t<TRes>
  ...
  _CopyWithImpl$Query$Foobar$ts$t(this._instance, this._then);
...
class Query$Foobar$tss {
  Query$Foobar$tss({required this.nameEnforced, this.$__typename = 'TS'});
  ...
  int get hashCode {
    final l$nameEnforced = nameEnforced;
    final l$$__typename = $__typename;
    return Object.hashAll([l$nameEnforced, l$$__typename]);
  }
...
extension UtilityExtension$Query$Foobar$tss on Query$Foobar$tss {
  CopyWith$Query$Foobar$tss<Query$Foobar$tss> get copyWith =>
      CopyWith$Query$Foobar$tss(this, (i) => i);
}
...
abstract class CopyWith$Query$Foobar$tss<TRes> {
  ...
  TRes call({String? nameEnforced, String? $__typename});
}

class _CopyWithImpl$Query$Foobar$tss<TRes>
    implements CopyWith$Query$Foobar$tss<TRes> {
  _CopyWithImpl$Query$Foobar$tss(this._instance, this._then);
...
class _CopyWithStubImpl$Query$Foobar$tss<TRes>
  ...
  call({String? nameEnforced, String? $__typename}) => _res;
}
