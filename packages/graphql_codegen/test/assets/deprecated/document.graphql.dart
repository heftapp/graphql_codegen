...
class Query$Q {
  Query$Q({this.deprecatedField, this.$__typename = 'Query'});
  ...
  Map<String, dynamic> toJson() {
    ...
    _resultData['deprecatedField'] = l$deprecatedField == null
        ? null
        : toJson$Enum$E(l$deprecatedField);
  ...
  int get hashCode {
    final l$deprecatedField = deprecatedField;
    final l$$__typename = $__typename;
    return Object.hashAll([l$deprecatedField, l$$__typename]);
  }
...
abstract class CopyWith$Query$Q<TRes> {
  ...
  TRes call({Enum$E? deprecatedField, String? $__typename});
}
...
class _CopyWithStubImpl$Query$Q<TRes> implements CopyWith$Query$Q<TRes> {
  ...
  call({Enum$E? deprecatedField, String? $__typename}) => _res;
}
