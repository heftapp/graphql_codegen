...
const documentNodeMutationUpdateSNo = DocumentNode(
  definitions: [
...
typedef OnMutationCompleted$Mutation$UpdateSNo =
    FutureOr<void> Function(Map<String, dynamic>?, Mutation$UpdateSNo?);
...
class Mutation$UpdateSNo$HookResult {
  Mutation$UpdateSNo$HookResult(this.runMutation, this.result);
...
Mutation$UpdateSNo$HookResult useMutation$UpdateSNo([
  ...
  final result = graphql_flutter.useMutation(
    options ?? WidgetOptions$Mutation$UpdateSNo(),
  );
...
graphql.ObservableQuery<Mutation$UpdateSNo> useWatchMutation$UpdateSNo([
  ...
  options ?? WatchOptions$Mutation$UpdateSNo(),
);
...
typedef Builder$Mutation$UpdateSNo =
