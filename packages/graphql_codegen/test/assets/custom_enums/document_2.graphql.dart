import './enum.dart' as EnumImport$Enum;
import 'package:gql/ast.dart';

class Query$Q {
  Query$Q({this.value, this.$__typename = 'Query'});
  ...
  factory Query$Q.fromJson(Map<String, dynamic> json) {
    ...
    return Query$Q(
      value: l$value == null
          ? null
          : EnumImport$Enum.fromJson((l$value as String)),
      $__typename: (l$$__typename as String),
    );
  }

  final EnumImport$Enum.FancyEnum? value;
  ...
  Map<String, dynamic> toJson() {
    ...
    final l$value = value;
    _resultData['value'] = l$value == null
        ? null
        : EnumImport$Enum.toJson(l$value);
...
abstract class CopyWith$Query$Q<TRes> {
  ...
  TRes call({EnumImport$Enum.FancyEnum? value, String? $__typename});
}
      ...
      _then(
        Query$Q(
          value: value == _undefined
              ? _instance.value
              : (value as EnumImport$Enum.FancyEnum?),
...
class _CopyWithStubImpl$Query$Q<TRes> implements CopyWith$Query$Q<TRes> {
  ...
  call({EnumImport$Enum.FancyEnum? value, String? $__typename}) => _res;
}
