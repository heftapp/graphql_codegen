...
class Input___Input {
  factory Input___Input({Enum___Status? status}) =>
      Input___Input._({if (status != null) r'status': status});
  ...
  CopyWith___Input___Input<Input___Input> get copyWith =>
      CopyWith___Input___Input(this, (i) => i);
...
class _CopyWithImpl___Input___Input<TRes>
  ...
  _CopyWithImpl___Input___Input(this._instance, this._then);
  ...
  TRes call({Object? status = _undefined}) => _then(
    Input___Input._({
      ..._instance._$data,
...
typedef OnQueryComplete___Query___Q =
    FutureOr<void> Function(Map<String, dynamic>?, Query___Q?);
