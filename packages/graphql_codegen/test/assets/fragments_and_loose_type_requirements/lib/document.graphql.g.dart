...
QueryQ1 _$QueryQ1FromJson(Map<String, dynamic> json) {
  return QueryQ1(
    t: json['t'] == null
        ? null
...
QueryQ1$t _$QueryQ1$tFromJson(Map<String, dynamic> json) {
  return QueryQ1$t(
...
QueryQ1$t$t _$QueryQ1$t$tFromJson(Map<String, dynamic> json) {
  return QueryQ1$t$t(
    name: json['name'] as String?,
  );
}
