...
const documentNodeFragmentT1 = DocumentNode(
  definitions: [fragmentDefinitionT1],
);
...
class _CopyWithImpl$Fragment$T2<TRes> implements CopyWith$Fragment$T2<TRes> {
  ...
  TRes call({Object? t = _undefined, Object? name = _undefined}) => _then(
    Fragment$T2(
...
const documentNodeFragmentT2 = DocumentNode(
  definitions: [fragmentDefinitionT2],
);
...
const documentNodeFragmentTC = DocumentNode(
  definitions: [
