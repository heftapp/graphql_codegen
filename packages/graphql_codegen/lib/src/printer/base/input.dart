        ...
        ..constructors = ListBuilder([
                ...
                ..body = refer(name(context.path)).property('_').call([
                    ...
                    Code("""
                  {
                    ${properties.map((property) {
                      ...
                      final value = context.namePrinter.printPropertyName(property.name);
          ...
          Constructor(
            (b) => b
              ...
              ..body = _printFromJson(context, name(context.path), properties),
          ),
        ])
        ..fields = ListBuilder([
          Field(
        ...
        ..methods = ListBuilder([
          ...properties.map(
            (e) => Method((b) {
              ...
              final returnType = e.hasDefaultValue
                  ? asNullable(innerType)
                  : innerType;
              b
                ...
                ..body = refer(
                  kDataVariableName,
                ).index(literalString(e.name.value)).asA(returnType).code;
            }),
          ),
          Method(
            (b) => b
          ...
          if (!context.context.config.disableCopyWithGeneration)
            Method(
              (b) => b
                ...
                ..type = MethodType.getter
                ..returns = generic(
                  context.namePrinter.printCopyWithClassName(
                    name(context.path),
                  ),
          ...
          CodeExpression(
            Block.of([
              ...
              ...properties.expand((prop) {
                final propName = context.namePrinter.printPropertyName(
                  prop.name,
                );
                return [
                  if (prop.isNonNull)
                  ...
                  refer(
                    propName,
                  ).asA(printClassPropertyType(context, prop)).code,
                  Code(','),
                ];
              }),
              Code('}'),
...
Constructor _printInputBuilderConstructor({
  ...
  final buildPropertyMapEntry = (ContextProperty property) => MapEntry(
    ...
    property.hasDefaultValue
        ? asNullable(printClassPropertyType(context, property))
        : printClassPropertyType(context, property),
  );
  final fnName = 'fn';
  return Constructor(
...
Code _printFromJson(
  ...
  return Block.of([
    ...
    refer(
      name,
    ).property('_').call([refer(resultDataVariableName)]).returned.statement,
  ]);
}
